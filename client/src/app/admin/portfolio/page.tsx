    ...
    return (
        <div>
            <div className="flex justify-between items-center mb-8">
                <h1 className="text-3xl font-bold text-blue-black">Portfolio</h1>
                    ...
                    <tbody className="divide-y divide-gray-100">
                        {[1, 2, 3].map((item) => (
                            <tr key={item} className="hover:bg-gray-50 transition-colors">
                                <td className="p-4 font-medium text-blue-black">Project Title {item}</td>
                                <td className="p-4 text-gray-600">Web Development</td>
                                <td className="p-4 text-gray-600">150% Growth</td>
